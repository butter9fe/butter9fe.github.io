...
function transformCard(mouseEvent, card, cardSub) {
    ...
    if (window.innerWidth <= 720) centerY = card.clientHeight / 2;
...
if (document.URL.includes("work.html")) {
    ...
    window.addEventListener("load", ()=>{
        ...
        (0, _smoothScrollbarDefault.default).use((0, _scrollDisable.ModalPlugin));
        const verticalScrollbar = (0, _smoothScrollbarDefault.default).init(content, {
            damping: 0.05,
            delegateTo: document
        });
        ...
        verticalScrollbar.addListener(({ offset  })=>{
            ...
            const rotatePercentage = (progress * 108 / 360 + 225).toFixed(0);
            (0, _gsap.gsap).to(scrollBar, {
                transform: `rotate(${rotatePercentage}deg)`
            });
        });
        const initMenu = ()=>{
            const { X , Y  } = constants.SIZES.MENU;
            (0, _gsap.gsap).to(scrollMenu, {
                delay: 0.8,
                autoAlpha: 1,
                ease: (0, _gsap.Power1).easeOut
            });
            navContainer.forEach((navItem, index)=>{
                ...
                tl.to(navItem, {
                    ...
                    autoAlpha: 1,
                    ease: (0, _gsap.Power1).easeOut
                }).then(()=>verticalScrollbar.updatePluginOptions("modal", {
                        open: false
                    }));
                navItem.addEventListener("click", ()=>{
                    const scrollContent = [].slice.call(document.querySelector(".scroll-content").querySelectorAll(".item"));
                    const scrollItem = scrollContent.find(({ dataset  })=>dataset.id === navItem.dataset.id);
        ...
        const onMenuSelect = (selectedItem)=>{
            ...
            for (const [i, navItem] of navContainer.entries()){
                ...
                const index = i + 1;
                const currentItemYPos = (0, _gsap.gsap).getProperty(navItem, "translateY");
                const selectedItemYPos = (0, _gsap.gsap).getProperty(selectedItem, "translateY");
                const translateSteps = selectedItemYPos / Y;
                const translateValue = translateSteps * Y;
                (0, _gsap.gsap).to(navItem, {
                    transform: `translate(
        ...
        const toggleActive = (item)=>{
            navContainer.forEach((n)=>{
                if (n.dataset.id === item.dataset.id) item.classList.add("active");
                else n.classList.remove("active");
            });
        };
        const generateList = ()=>{
            const scrollContent = document.querySelector(".scroll-content");
            (0, _data.DATA).forEach((item)=>scrollContent.appendChild(createItem(item)));
            scrollContent.classList.add((0, _data.DATA).length % 2 === 0 ? "even" : "odd");
            if (scrollContent.children.length === (0, _data.DATA).length) (0, _gsap.gsap).to(scrollContent, {
                autoAlpha: 1,
                delay: 1
            });
        };
        const createItem = (item)=>{
            ...
            if (item.hasOwnProperty("navId")) itemContainer.setAttribute("data-id", item.navId);
            return itemContainer;
        };
        const animateList = ()=>{
            (0, _gsap.gsap).to(side.children, {
                stagger: 0.15,
                delay: 1,
                y: 0,
                autoAlpha: 1
        ...
        let observer = new IntersectionObserver((entries, _)=>{
            entries.forEach((entry)=>{
                if (entry.isIntersecting) {
                    const selection = navContainer.find(({ dataset  })=>dataset.id === entry.target.dataset.id);
                    if (Boolean(selection)) onMenuSelect(selection);
                }
            });
        }, options);
...
},{"smooth-scrollbar":"7azJf","gsap":"fPSuC","./plugins/scroll-disable":"5G4gi","./data":"kq51T","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7azJf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5G4gi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ModalPlugin", ()=>ModalPlugin);
var _smoothScrollbar = require("smooth-scrollbar");
class ModalPlugin extends (0, _smoothScrollbar.ScrollbarPlugin) {
...
},{"smooth-scrollbar":"7azJf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kq51T":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const DATA = [
    ...
    },
    {
        id: 16,
        title: "Shubham Dhage",
        imgUrl: "https://images.unsplash.com/photo-1643632406503-67e55e5ba526?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2664&q=80\xcf"
    },
    {
        id: 17,
        title: "Smit Patel",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eZyLq","dV6cC"], "dV6cC", "parcelRequire81e8")

//# sourceMappingURL=experiences.e82f28a0.js.map
